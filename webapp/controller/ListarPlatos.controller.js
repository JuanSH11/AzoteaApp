sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.azoteaApp.controller.ListarPlatos", {
				...
				.then(function(result) {
					if (result === false) {
						...
						return new Promise(function(fnResolve) {
							...
							sap.m.MessageToast.show("Plato eliminado", {
								onClose: fnResolve,
								duration: 2000 || 3000,
								at: sTargetPos,
								my: sTargetPos
		...
		onInit: function() {
			...
			this.oRouter.getTarget("ListarPlatos").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
