sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.azoteaApp.controller.VerIngrediente", {
		handleRouteMatched: function(oEvent) {
			...
			if (!this.sContext) {
				this.sContext = "IngredienteSet('100000011')";
			}
		...
		_onFioriObjectPageActionButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("CrearIngrediente", oBindingContext, fnResolve, "");
		...
		_onFioriObjectPageActionButtonPress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("IngresarStock", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onFeedListItemIconPress: function(oEvent) {

			var oBindingContext = oEvent.getSource().getBindingContext();

			return new Promise(function(fnResolve) {

				this.doNavigate("VerPlato", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("VerIngrediente").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1-sectionContent-Fiori_ObjectPage_ContactList-1683585157576",
				"groups": ["content"]
			}, {
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-2-sectionContent-sap_m_FeedList-1683578197002",
				"groups": ["items"]
			}];
