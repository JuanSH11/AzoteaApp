sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.azoteaApp.controller.VerPlato", {
		...
		_onFioriObjectPageActionButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("CrearPlato", oBindingContext, fnResolve, "");
		...
		_onFioriObjectPageActionButtonPress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Analiticas", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("VerPlato").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				...
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-3-sectionContent-sap_m_FeedList-1683576718301",
				"groups": ["items"]
			}];
